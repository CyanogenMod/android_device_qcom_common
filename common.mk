...
ALSA_UCM += HiFi_Tunnel_2x
ALSA_UCM += snd_soc_msm_2x
ALSA_UCM += DL_REC_2x_Fusion3
ALSA_UCM += FM_A2DP_REC_2x_Fusion3
ALSA_UCM += FM_Digital_Radio_2x_Fusion3
ALSA_UCM += FM_REC_2x_Fusion3
ALSA_UCM += HiFi_2x_Fusion3
ALSA_UCM += HiFi_Low_Power_2x_Fusion3
ALSA_UCM += HiFi_Rec_2x_Fusion3
ALSA_UCM += UL_DL_REC_2x_Fusion3
ALSA_UCM += Voice_Call_2x_Fusion3
ALSA_UCM += Voice_Call_IP_2x_Fusion3
